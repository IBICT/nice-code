...
AI checks are powered by the open-source Nice Code CLI (`cn`).

**macOS / Linux:**

```bash
curl -fsSL https://raw.githubusercontent.com/ibict/nice/main/extensions/cli/scripts/install.sh | bash
```

**Windows (PowerShell):**

```powershell
irm https://raw.githubusercontent.com/ibict/nice/main/extensions/cli/scripts/install.ps1 | iex
```
...
Read the [contributing guide](https://github.com/ibict/nice/blob/main/CONTRIBUTING.md), and
join the [GitHub Discussions](https://github.com/ibict/nice/discussions).

## License

[Apache 2.0 © 2026 IBICT.](./LICENSE)
